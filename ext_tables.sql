...
#
# Table structure for table 'tx_pxaintelliplanjobs_domain_model_applyapplication'
#
CREATE TABLE tx_pxaintelliplanjobs_domain_model_applyapplication (

	uid int(11) NOT NULL auto_increment,
	pid int(11) DEFAULT '0' NOT NULL,

	account_ticket varchar(255) DEFAULT '' NOT NULL,
